===Custom Add To Cart Text Desktop Mobile ===
Contributors: zyonstudios
Tags: Add to cart button,cart, button,cart button text
...
Change the Add to Cart button's text according to the device.
Requires WooCommerce plugin to be installed.

== Description ==
This is an simple plugin that customize the add to cart button text with the option to have different text on desktop and mobile devices.
...
== Screenshots ==
1. Example setting mobile add to cart button text.
2. Example setting out of stock button text.
3. Example setting Select Options button text in variable profucts.
...
The plugin now requires a minimum PHP version of 5.2.
